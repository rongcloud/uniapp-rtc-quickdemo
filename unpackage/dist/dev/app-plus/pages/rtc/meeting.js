...
(() => {
        ...
        (0, import_vue2.createElementVNode)("view", { class: "control-panel" }, [
            ...
            (0, import_vue2.createElementVNode)(
              ...
              [
                (0, import_vue2.createElementVNode)(
                  "u-text",
                  { class: "btn-text" },
                  (0, import_vue2.toDisplayString)($data.isJoining ? "\u52A0\u5165\u4E2D..." : "\u52A0\u5165\u623F\u95F4"),
                  1
                  /* TEXT */
                )
              ],
          ...
          (0, import_vue2.createElementVNode)("view", { class: "button-row" }, [
            (0, import_vue2.createElementVNode)("view", {
              ...
              (0, import_vue2.createElementVNode)("u-text", { class: "btn-text" }, "\u53D1\u5E03\u8D44\u6E90")
            ]),
            (0, import_vue2.createElementVNode)("view", {
              class: "control-btn rtc-btn",
          ...
          (0, import_vue2.createElementVNode)("view", { class: "button-row" }, [
            (0, import_vue2.createElementVNode)("view", {
              ...
              (0, import_vue2.createElementVNode)("u-text", { class: "btn-text" }, "\u8BA2\u9605\u8D44\u6E90")
            ]),
            (0, import_vue2.createElementVNode)("view", {
              class: "control-btn rtc-btn",
          ...
          (0, import_vue2.createElementVNode)("view", { class: "button-row" }, [
            (0, import_vue2.createElementVNode)("view", {
              ...
              (0, import_vue2.createElementVNode)("u-text", { class: "btn-text" }, "\u6253\u5F00\u6444\u50CF\u5934")
            ]),
            (0, import_vue2.createElementVNode)("view", {
              class: "control-btn rtc-btn",
          ...
          (0, import_vue2.createElementVNode)("view", { class: "button-row" }, [
            (0, import_vue2.createElementVNode)("view", {
              ...
              (0, import_vue2.createElementVNode)("u-text", { class: "btn-text" }, "\u6253\u5F00\u9EA6\u514B\u98CE")
            ]),
            (0, import_vue2.createElementVNode)("view", {
              class: "control-btn rtc-btn",
          ...
          (0, import_vue2.createElementVNode)("view", { class: "button-row" }, [
            (0, import_vue2.createElementVNode)("view", {
              ...
              (0, import_vue2.createElementVNode)("u-text", { class: "btn-text" }, "\u6253\u5F00\u626C\u58F0\u5668")
            ]),
            (0, import_vue2.createElementVNode)("view", {
              class: "control-btn rtc-btn",
              onClick: _cache[13] || (_cache[13] = ($event) => $options.enableSpeaker(false))
            }, [
              (0, import_vue2.createElementVNode)("u-text", { class: "btn-text" }, "\u5173\u95ED\u626C\u58F0\u5668")
            ])
          ])
        ])
      ])
  ...
  var meeting = /* @__PURE__ */ _export_sfc(_sfc_main2, [["render", _sfc_render2], ["styles", [_style_0]], ["__file", "/Users/yongqiming/developer/android/project/rongcloud/uniapp-rtc-quickdemo/pages/rtc/meeting.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/rtc/meeting";
    let __pageQuery = {};
    try {
    ...
    meeting.mpType = "page";
    const app = Vue.createPageApp(meeting, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...meeting.styles || []]));
    app.mount("#root");
  }
})();
